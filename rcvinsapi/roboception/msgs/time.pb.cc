...
void protobuf_AssignDesc_roboception_2fmsgs_2ftime_2eproto() {
  protobuf_AddDesc_roboception_2fmsgs_2ftime_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "roboception/msgs/time.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_roboception_2fmsgs_2ftime_2eproto);
}
...
void protobuf_ShutdownFile_roboception_2fmsgs_2ftime_2eproto() {
  delete Time::default_instance_;
  delete Time_reflection_;
}

void protobuf_AddDesc_roboception_2fmsgs_2ftime_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\033roboception/msgs/time.proto\022\020robocepti"
    "on.msgs\"!\n\004Time\022\013\n\003sec\030\001 \001(\003\022\014\n\004nsec\030\002 \001"
    "(\005B\"\n\024com.roboception.msgsB\nTimeProtos", 118);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "roboception/msgs/time.proto", &protobuf_RegisterTypes);
  Time::default_instance_ = new Time();
  Time::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_roboception_2fmsgs_2ftime_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_roboception_2fmsgs_2ftime_2eproto {
  StaticDescriptorInitializer_roboception_2fmsgs_2ftime_2eproto() {
    protobuf_AddDesc_roboception_2fmsgs_2ftime_2eproto();
  }
} static_descriptor_initializer_roboception_2fmsgs_2ftime_2eproto_;
...
const Time& Time::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_roboception_2fmsgs_2ftime_2eproto();
